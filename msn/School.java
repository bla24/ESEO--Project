...
class School {
    ...
    int numberStudentsEnrolled;
    /** Current count of employed teachers */
    int numberTeachersEmployed;
     ...
     */
    void setNumberStudentsEnrolled(int numberStudentsEnrolled) {
     ...
     */
    void setNumberTeachersEmployed(int numberTeachersEmployed) {
     ...
     */
    void enrollStudent(Student student, LocalDate enrollmentDate) {
     ...
     * @param enrollmentDate The date of enrollment
     */
    void enrollStudent(String forename, String surname, LocalDate dateOfBirth, LocalDate enrollmentDate) {
        if(numberStudentsEnrolled >= students.length) {
            System.out.println("Cannot enroll anymore students.");
            return;
        }
     ...
     */
    void employTeacher(Teacher teacher, LocalDate startDate){
     ...
     * @param startDate The employment start date
     */
    void employTeacher(String forename, String surname, LocalDate dateOfBirth, LocalDate startDate){
        if(numberTeachersEmployed >= teachers.length) {
            System.out.println("Cannot employ anymore teachers.");
            return;
        }
     ...
     */
    static String shorten(String input, int maxLength){
     ...
     */
    static String generateTeacherUsername(Teacher teacher){
     ...
     * @return Generated username
     */
    static String generateStudentUsername(Student student){
        StringBuilder username = new StringBuilder();
